...
**Spring Boot Starter for sigar-native**

[![Maven Central](https://img.shields.io/maven-central/v/io.github.easy4j/sigar-spring-boot-starter)](https://github.com/easy-4-java/sigar-spring-boot-starter)
...
> **Current Version**：`2.7.x.20240824.RELEASE`<br>
> **JDK Baseline**：`17`<br>
> **Group ID**：`io.github.easy4j`<br>
> **Artifact ID**：`sigar-spring-boot-starter`<br>
> **License**：Apache License 2.0<br>

## 1. Positioning

**sigar-spring-boot-starter** is a Spring Boot starter that integrates **sigar-native** for applications using sigar-native. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume sigar-native capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using sigar-native |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for sigar-native |
| JDK | `17` |
| Coordinates | `io.github.easy4j:sigar-spring-boot-starter:2.7.x.20240824.RELEASE` |
| Config Prefix | `sigar` |
...
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers sigar-native beans automatically |
| Property Binding | ✅ Stable | Binds `sigar.*` to `SigarProperties` |
| `SigarMetrics` bean | ✅ Stable | Auto-registered via SigarAutoConfiguration |
...
|---|---|---|
| `SigarMetrics` | classpath + property | not created |
...
<dependency>
    ...
    <version>2.7.x.20240824.RELEASE</version>
</dependency>
```
...
|---|---|---|:---:|---|:---:|
| `sigar.enabled` | boolean | `true` | No | Enable the starter | No |
...
```bash
mvn clean verify
mvn -pl sigar-spring-boot-starter -am test
```
...
|---|---|---|
| Bean not created | Check auto-configuration report | Verify `sigar.enabled=true` and classpath |
...
[Back to top](#readme-top) · [Issues](https://github.com/easy-4-java/sigar-spring-boot-starter/issues) · [Repository](https://github.com/easy-4-java/sigar-spring-boot-starter)
